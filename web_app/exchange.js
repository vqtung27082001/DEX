...
const exchange_name = 'SWAP';             // TODO: fill in the name of your exchange

const token_name = 'anh7goat';                // TODO: replace with name of your token
const token_symbol = 'SIUU';              // TODO: replace with symbol for your token
...
async function init() {
    ...
    if (poolState['token_liquidity'] === 0
      ...
      await exchange_contract.connect(provider.getSigner(defaultAccount)).createPool(5000,
